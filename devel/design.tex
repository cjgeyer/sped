...
We also adopt the convention $g_S() = 1$, which makes sense because the
...
are the unnumbered displayed equations on pp.~{33--34} in \citet{geyer},
except that two typographical errors have been correct, one minor (a missing
